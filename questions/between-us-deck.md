...
## Friendship
1. What did your best friendship teach you that no romance did?
2. It's 2 a.m. What kind of friend are you?
...
2. What question have you wanted to ask me but haven't?
3. What do we have in common that neither of us has named?
4. What do you think I need to hear right now?
5. What did I do that affected you more than I probably realise?
6. What's one thing you know about me that I don't know you know?
7. Quote something I once said that stuck with you.
...
2. What do we never do that you wish we did?
3. What do I still not understand about you?
4. What do you think I need from this friendship that I've never said?
5. How has this friendship changed you?
6. What's your favourite story about us that you tell other people?
7. What would end this friendship?
...
9. Where am I still a mystery to you?
10. Pick the fight we should have more honestly.
11. When do you feel most like yourself with me?
12. When did you decide I was worth it?
...
- **Connect** — "Is there something you wish people asked you instead of 'how are you'?" (displaced from Connect 8 in v6.69 by the substance-worry card, finally given a home)
- **Connect** — "Where are you a regular — and do they know your name?" (displaced from Connect 10 in v6.69 by the ordinary-conflict card)
- **Culture** — "Which piece of music do you protect — the one you won't play for just anyone?" (displaced from Culture 3 in v6.69)
- **Culture** — "You collect something, officially or accidentally..." (displaced from Culture 4 in v6.69)
- **Culture** — "The one you love that everyone else seems to have missed..." (displaced from Culture 8 in v6.69)
- **Deep** — "You're still waiting for someone to notice..." (displaced from Deep 2 in v6.69)
- **Friendship** — "What do you say about your friends when they're not there?" (displaced from Friendship 9 in v6.69 by the trust-style card)
- **Life** — "Is an ordinary life something to fear or to aim for?" (displaced from Life 7 in v6.69)
- **Life** — "How much of your day runs on autopilot, honestly?" (displaced from Life 10 in v6.69)
- **Mind** — "What can you still do for three hours without noticing?" (displaced from Mind 5 in v6.69 by the boredom/silence card — finally seats the Boredom gap noted earlier)
- **Mind** — "Do you decide fast and adjust, or slow and stick?" (displaced from Mind 8 in v6.69)
- **Self** — "Do you take up space in a room, or fold into it?" (displaced from Self 6 in v6.69 by the power card — finally seats the Power gap noted earlier)
- **Unwind** — "What hobby have you never gotten tired of, even after years?" (displaced from Unwind 2 in v6.69)
- **Unwind** — "Some things look like rest and leave you emptier..." (displaced from Unwind 5 in v6.69)
- **Warm** — "Whose skill do you quietly envy?" (displaced from Warm 8 in v6.69, replaced with a near-identical but sharper phrasing of the same card)
- **Wish** — "A free year, no obligations — what finally gets done?" (displaced from Wish 9 in v6.69)
- **Work** — "Tell about your most instructive professional failure." (displaced from Work 6 in v6.69)
- **Work** — "What does the word \"retirement\" do to you?" (displaced from Work 11 in v6.69)
...
**Entered — Connect 8/10, Culture 3/4/8, Deep 2, Friendship 9, Life 7/10, Mind 5/8, Self 6, Unwind 2/5, Values 3, Warm 8, Wish 8/9, Work 1/4/6/11.** Full text in the categories above; displaced cards moved to BENCH.

Three collisions held in v6.68 are resolved by this batch:
- **Culture 9 vs Culture 12** — resolved: Culture 9 stays unchanged, Culture 12 gets fresh unrelated wording.
- **Work 4 vs Work 11** — resolved: Work 1's old "strangest job" text relocated to Work 4, Work 11 gets fresh "would you rather" wording. No twins.
- **Life 10 vs Wish 8** — resolved: Life 10 gets fresh wording, freeing Wish 8 to take the previously-held "life seen from the outside" card.

**New collisions found in this batch, held rather than entered:**
- **Culture 5** ("stop talking mid-sentence... just to look at it") vs **Culture 10** ("beauty catch you completely unprepared") — same mechanism.
- **Culture 12** ("return to for the feeling of it, not the meaning") vs **Culture 1** ("piece of art still does something to you, every time") — same mechanism.
- **Roots 7** ("who from school still owes you an apology") vs **Shadow 12** ("Which apology do you still owe?") — overlapping apology theme.
- **Self 7** ("something about getting older turned out better than expected") vs **Life 9** ("what getting older takes... and gives") — near-twin.
- **Values 8** ("most money spent on something impractical") vs **Quick 3** ("greatest extravagance") — same concept.
- **Friendship 8** ("part of your personality shaped by your friends") vs **Friendship 1** ("what did your best friendship teach you") — unresolved from v6.68, Friendship 1 untouched in this batch too.

None of these six are entered. Waiting on the owner.
...
After: What = 71 (14%), Which = 72 (15%), What's = 17. Remaining spread across imperatives (Name, Tell, Describe, Admit, Confess, Defend, Point, Sing, Empty, Walk me through — 60+), second-person statements ("You lie most consistently about...", "Your body asks for something you routinely deny it..."), scene-setters ("It's 2 a.m.", "Someone is close.", "The novelty burns off."), fragments, and conditionals.
108 cards rewritten. Essence unchanged in every case — only the construction. The second-person statement form ("You're still waiting for someone to notice...") is the biggest gain: it asserts the thing as true of the player before asking, which removes the escape route that "What are you waiting for?" leaves open.

## Patch v5.9
Friendship 4 → "Which friend gets the honest version of you — and which gets the polite one?" (trait-list card out; friction in). Values 7 → "When did you stay silent and shouldn't have?" — the Leuterspel party scenario (H7) cut: hypothetical, scripted, and it collided with the new Friendship 4. The replacement asks for the real event instead of the imagined one, and covers all silence, not just a friend at a party.
**Friendship-over-time:** covered by Friendship 12 ("Are you a better friend now than ten years ago — by whose measure?"). Deliberately not adding a second — the change-over-time story would be told twice.

## Patch v5.8 — agreed mechanical fixes
Quick: this-or-that reduced from 5 to 2 (coffee order, shower). Cut: sweet/savoury, window/aisle (overused), cash, salt/pepper, eaten-standing-up (flat), last-text (phone card returning through the back door), currently-avoiding (not a ten-second question — it's a Raw card in disguise). Final twelve reach untouched ground: possessions, small shame, homecoming ritual, what you're wearing.
Home 1: cut as duplicate of the "I feel at home the moment..." fragment → "Who is allowed in your home unannounced?" (boundary/intimacy, new ground for Home).
Life 8: time-ownership fragment cut (third such card in Life) → "What are you putting off that you know you'll regret?"
Culture 8: "whatever its worth" clause cut — it steered toward money/status → "Which celebrated work of art do you find genuinely bad?"
Move 1: descriptive/adjectival → "Your body can still do something that surprises people..."
Warm 2: "far more than it deserves" steering clause cut → "One small thing can ruin your entire morning. Which?"
**Kept against review, with reasons:** Connect yes/no cards (they force a specific person to mind — that's strength, not awkwardness). Raw jealousy (the risk named is a facilitation risk, not a card flaw). Grief closure (one abstract card among ten concrete ones is variety per US-084, not dilution). Past twenty-year-old, Ground who-is-your-ground (not broken; Ground-includes-people is a design choice, deliberately kept).

## Patch v5.7 — mechanical-emptiness pass
**Quick de-phoned:** 7 of 12 were phone cards (apps, emoji, sound/silent, lock screen, saved-for-later, first-thing-checked, last-photographed). All replaced with tech-free 10-second cards (unneeded purchase, disgrace drawer, cash, always-late-for, chair-choice, bag contents, salt/pepper). Life 11 (phone in three words) also cut — deck is now tech-reference-free and will not date.
**Roots hardened:** name-story, childhood-friend-surprised, dinner-table, kept-tradition → "At home, to be safe, you had to be..." / "Before you were ten, you'd already learned to hide..." / "You grew up around something you thought was normal. It wasn't." / "Who in your childhood should not have been given a child?" Roots now has a door for upbringings that were not survivable in a fond register.
**Exuberance in:** Playful 9 (gloriously too far) and 10 (excess, unapologetically) replace walk-in song and conspiracy theory.
**Summary/list cards cut:** Mind 11–12 (best-thoughts-location, think-in-language) → "what do you think about far more than you let on" / "which idea changed you, and how did it get in". Grief 9 (how do you grieve) → "what does nobody know you still do because of them". Body 11 (illness→lesson, pre-loaded the answer as meaning, US-085 violation) → "which injury or illness does your body still remember". Family 11 (family showed up) → "what does your family not know about you". Us: Friends 7 (twenty years) → "what would end this friendship". Us: Love 8 (better than any couple) → "tell me what you'd change about us if I couldn't take it personally".
**Rejected from review:** all Quick/Warm/Playful "not revealing enough" flags (category confusion — those cards are doing their job per US-012/083), all broad-philosophy flags (deliberate design).

## Patch v5.6
Attract 1 stripped of steering examples → "Which specific details do it for you — every single time?" Blunt 2: non-human question cut (toys covers the territory); sex-importance confession moved in from the bench. Carnal 10 → "Alone or with someone — what does a toy give you that no body can?"

## Patch v5.5
Desire orphans placed. Attract 12: "being desired" in, "physical detail that undoes" out — it was the mirror of Attract 1 (both elicit a list of physical details, one positive one negative; same story twice). Carnal 12: lust↔wellbeing barometer in, "how important is sex in your life" out — both occupied the sex-in-life-context slot; the barometer version produces self-observation nobody's been asked before, the importance version produces a rating.

## Patch v5.4
Desire category deleted (weakest of the adult wing). Toys → "what do they bring that even a partner can't?" Kinks 7 sharpened to fetish-specific (dedup vs Flesh 6 unfulfilled-fantasy). Blunt 9 → count with breakdown invitation. Orphans worth remembering from Desire: "Being desired does what to you?" and the lust↔wellbeing card — available if a swap ever opens.

## Patch v5.3
New category **Blunt 🔞** — the direct-to-a-fault Leuterspel register isolated: Edge 10 (unsafe-persuasion), Flesh 6 (non-human), Flesh 7 (broadened to fast-or-slow), Flesh 8 (own-sex nakedness) moved in, plus 8 new in the same register (faked orgasm, walked in on, off-limits partner, longest drought, count, STI test, which-sex-delivers, paid/been-paid). Edge 10 ← strangest-place (from Carnal). Carnal 10 → "Toys: what do they bring that hands don't?" Flesh 6–8 refilled on-theme: unfulfilled fantasy (outright), arousal-trace, loud/silent.
