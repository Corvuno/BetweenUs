...
const CATEGORIES = {
  ...
  self:   { label:"Self",   color:"#476d95", band:5, focus:-1,
  ...
  mind:   { label:"Mind",   color:"#3f5e97", band:3, focus:-0.9,
            ...
            chapter:"findout", bucket:"reflection" },
  body:   { label:"Body",   color:"#5c8798", band:5, focus:-0.8,
            desc:"Living in a body — pleasure, tension, failure and repair",
            chapter:"findout", bucket:"reflection" },
  values: { label:"Values", color:"#697bab", band:5, focus:-0.7,
            desc:"Where your lines are — and what it costs to hold them",
            chapter:"findout", bucket:"reflection" },
  wish:   { label:"Wish",   color:"#786cae", band:3, focus:-0.7,
