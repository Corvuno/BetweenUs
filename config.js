...
const CATEGORIES = {
  ...
  culture:{ label:"Culture", color:"#bd9057", band:2, focus:0,
  ...
  unwind: { label:"Unwind", color:"#55a68f", band:2, focus:0,
            ...
            chapter:"surface", bucket:"everyday" },
  world:  { label:"World",  color:"#98874b", band:2, focus:0,
  ...
  friends:{ label:"Friendship", color:"#c99268", band:3, focus:0.5,
  ...
  attract:{ label:"Attract", color:"#dc8767", band:3, focus:0.7,
            ...
            chapter:"findout", bucket:"relationships" },
  family: { label:"Family", color:"#b07d56", band:5, focus:0.4,
  ...
  us:       { label:"Between Us",  color:"#dda474", band:4, focus:1,
              desc:"About this specific moment, between the two of you",
              chapter:"aboutus", bucket:"usb" },
  usfriend: { label:"Us: Friends", color:"#c29a68", band:4, focus:1,
